...
<?php
    session_start();
     require "../income/getcategory.php";
...
<body>
        ...
        <div class="table-container">
            ...
            <table>
                ...
                <tbody id="incomeTable">
                    ...
                    <?php
                        require "../income/getall.php";
                        foreach($incomes as $row){
                            echo '
                                <tr>
                                    <td class="date">' . $row['income_date'] . '</td>
                                    <td>' . $row['description'] . '</td>
                                    <td class="amount">' . $row['montant'] . '</td>
                                    <td>
                                        <div class="actions">
                                            <a href="../income/update.php?id=' . $row['id'] . '" class="btn-action btn-edit">
                                                <i class="fas fa-edit"></i>
                                                Edit
                                            </a>
                                            <a href="../income/delete.php?id=' . $row['id'] . '" class="btn-action btn-delete">
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            ...
            <form id="incomeForm" action="../income/create.php" method="POST">
